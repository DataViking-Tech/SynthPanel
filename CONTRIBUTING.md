...
The upstream repository is protected — direct branch pushes require collaborator
access, which is granted on request (see [Submitting Changes](#submitting-changes)).
...
access. A maintainer will review and grant it manually if appropriate.
