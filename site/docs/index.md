...
- [registry.md](https://github.com/DataViking-Tech/SynthPanel/blob/main/docs/registry.md) — the decentralized pack registry: `pack import gh:<user>/<repo>`, search, and verification.
