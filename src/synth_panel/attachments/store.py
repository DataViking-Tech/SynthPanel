...
:func:`synth_panel.persistence._atomic_write`. A blob whose sha256 is
...
def _data_dir() -> Path:
    return Path(os.environ.get("SYNTH_PANEL_DATA_DIR", "~/.synthpanel")).expanduser()
