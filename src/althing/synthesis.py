...
from althing.structured.models import PartialSummary
...
class AsyncLLMClient(Protocol):
    ...
    (and ``judge_enabled=True``), althing skips its own provider
    ...
    althing's threading primitives don't run.
...
class MapPhaseFailure(RuntimeError):
    ...
    :class:`althing.structured.models.PartialSummary`. Surfacing the
    ...
    *,
    ...
    Args:
        ...
        llm_client: Optional async client conforming to
            ...
            ``judge_enabled=True``, althing skips its own provider
    ...
    if pyodide_safe_mode:
        raise ValueError(
            ...
            "althing LLMClient uses threading.Lock / Semaphore which "
...
# protocol — consumers point althing at any text-completion endpoint —
