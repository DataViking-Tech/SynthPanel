...
* **Shape-agnostic.** Works on PollResult.responses (one question),
  ...
  :func:`althing.analysis.inspect.build_inspect_report` consumes.
...
def _looks_numeric(per_panelist: list[dict[str, Any]]) -> bool:
    ...
    a version string ("Althing v1.5.1…") gets classified as a scale
...
#
#   "Althing v1.5.1 would absolutely feel agent-ready…"  (text + version)
