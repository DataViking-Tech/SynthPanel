...
Bridges :class:`althing.llm.models.URLBlock` (a pre-fetch stub
...
:func:`althing.prompts.build_question_blocks` and before the
...
:mod:`althing.fetch`. This module is a thin adapter: map
