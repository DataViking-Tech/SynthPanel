...
from a post-synthesis :class:`~althing.orchestrator.PanelState` snapshot
plus the caller-supplied summary fields (headline, top verbatims, transcript
URI). Flag raising is delegated to AC-5
(:func:`~althing.orchestrator._raise_flags`) so the contract is enforced
...
from althing.orchestrator import Flag, PanelState, _raise_flags
