...
These mirror the JSON Schema dicts in :mod:`althing.structured.schemas`
...
class PartialSummary(BaseModel):
    ...
    Mirrors the content fields of :class:`althing.synthesis.SynthesisResult`
...
go through :func:`althing.structured.schemas.get_schema` (which
