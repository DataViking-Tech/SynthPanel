...
Walks the saved-results directory (default ``~/.althing/results/``),
...
:func:`althing.mcp.data.save_panel_result`. Sidecars (``*.pre-extend.json``,
...
def default_runs_dir() -> Path:
    ...
    Mirrors :func:`althing.mcp.data._results_dir` without invoking it
    ...
    base = Path(os.environ.get("SYNTH_PANEL_DATA_DIR", "~/.althing")).expanduser()
    return base / "results"
