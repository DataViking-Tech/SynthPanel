...
_ALIASES_FILE = Path.home() / ".althing" / "aliases.yaml"
_ENV_VAR = "ALTHING_MODEL_ALIASES"
...
def _load_file_aliases() -> dict[str, str]:
    """Load aliases from ~/.althing/aliases.yaml (tier 2).
...
def _load_env_aliases() -> dict[str, str]:
    """Load aliases from ALTHING_MODEL_ALIASES env var (tier 1, JSON)."""
