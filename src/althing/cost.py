"""Cost and budget tracking for althing.
...
_PROVIDER_BUCKETS = ("althing", "openrouter", "raw-anthropic", "raw-openai", "raw-gemini", "ollama")
...
def lookup_pricing_by_provider(provider_string: str) -> tuple[ModelPricing | None, bool]:
    ...
    Parses the bucket prefix (``althing/``, ``openrouter/``,
