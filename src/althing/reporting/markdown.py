...
if TYPE_CHECKING:
    from althing.analysis.inspect import InspectReport
...
FOOTER = "_Generated by althing report. Synthetic panel — AI-generated responses, not human data._"
...
def _provenance_block(
    ...
    *,
    ...
    althing_version = version.get("althing")
    ...
    rows: list[tuple[str, str]] = [
        ...
        ("althing_version", _fmt(althing_version)),
...
def _synthesis_block(report: InspectReport, raw: dict[str, Any]) -> list[str]:
    ...
    if not s.ran and s.error is None and s.summary_peek is None:
        ...
        if not report.has_rounds_shape:
            ...
            lines.append("")
            lines.append(
                f"> Generate it with: `althing panel synthesize {target}` "
