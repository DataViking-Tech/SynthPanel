"""CLI-level subgroup analysis for ``althing analyze subgroup``.
...
from althing.analysis.distribution import InvalidResponseSchemaError
from althing.analysis.subgroup import UnknownPersonaFieldError, subgroup_breakdown
...
def _chi2_sf(x: float, df: int) -> float:
    ...
    from althing.stats import _chi2_sf as _stats_chi2_sf  # type: ignore[attr-defined]
