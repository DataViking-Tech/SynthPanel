...
- ``gh:user/repo`` — defaults to ``ref=main``, ``path=althing-pack.yaml``
- ``gh:user/repo@ref``
- ``gh:user/repo:path``
...
Per S-gate OQ1, the default publishable path is ``althing-pack.yaml``
...
DEFAULT_REF = "main"
DEFAULT_PATH = "althing-pack.yaml"
