"""HTTP fetch of the althing pack registry ``default.json``.
...
live in :mod:`althing.registry.cache`.

The registry URL defaults to
``https://raw.githubusercontent.com/DataViking-Tech/althing-registry/main/default.json``
and can be overridden at runtime via ``ALTHING_REGISTRY_URL`` — useful
...
DEFAULT_REGISTRY_URL = "https://raw.githubusercontent.com/DataViking-Tech/althing-registry/main/default.json"
REGISTRY_URL_ENV = "ALTHING_REGISTRY_URL"
FETCH_TIMEOUT = 10.0


def registry_url() -> str:
    """Return the active registry URL, honoring ``ALTHING_REGISTRY_URL``."""
