"""Rich metadata for althing JSON output (synthbench integration).
...
def _get_althing_version() -> str:
    """Return the installed althing version."""
    try:
